...
themebut.onclick = async () => {
  if(themebut.innerHTML.toString() =="Dark Mode"){
    ...
    document.body.style.backgroundImage = "url('https://images.unsplash.com/photo-1615716039130-2d84e4bef125?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')";
    themebut.innerHTML="Dark Mode"
    let myElements = document.querySelectorAll(".btn");
    document.body.style.color="black";
     for (let i = 0; i < myElements.length; i++) {
	        myElements[i].style.border = "4px solid blue";
          } 
  }
